...
htmltools::tagList(
  tbl,
  htmltools::HTML(
    "<div style='font-size:0.55em; margin-top:6px; margin-left:0; text-align:left;'>Standard errors clustered by state. Significance levels: * p &lt; 0.05, ** p &lt; 0.01, *** p &lt; 0.001.</div>"
  )
)
```
