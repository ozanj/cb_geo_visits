...
make_rq2_fit_table <- function(tab_df) {
  ...
  # highlight colors
  # NOTE: #EEF4FF (original) is nearly invisible on a white slide background.
  # Current choice #BDD7EE is a classic Excel-style light blue — clearly visible
  # but still soft. Other options to try, lightest to darkest:
  # highlight colors — change eps_col_bg to any option below:
  #   "#D6E8F7"  very soft, closer to original intent
  #   "#BDD7EE"  Excel light blue, recommended default
  #   "#C6E2FF"  slightly more saturated
  #   "#ADD8E6"  CSS 'lightblue', more obvious
  #   "#9BC2E6"  medium-light blue, high contrast
  #   "#80D8FF"  lighter highlighter blue
  #   "#40C4FF"  ← current: neon highlighter blue
  eps_col_bg   <- "#80D8FF"
  ...
  tbl <- tab_one %>%
    ...
    # column_spec for the EPS column MUST come after the row_spec(background)
    # calls above. Both write inline background-color to the same <td> elements;
    # whichever is last in the pipe wins. Putting this last ensures the blue
    # overwrites the yellow for the Adj. R² cells in this column.
    column_spec(
      5,
